...
const billTypeToName: Record<string, string> = Object.keys(billListData).reduce((prev, key) => {
    billListData[key as keyof BillData].forEach(bill => {
...
export { billListData, billTypeToName };